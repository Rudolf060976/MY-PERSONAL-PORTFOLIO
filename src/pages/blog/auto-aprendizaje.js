...
function AutoAprendizajePage({ data }) {

    const postsArray = data.allMdx.nodes;

    const selectedPostsArray = postsArray.filter(post => {

        return (post.frontmatter.category === "Auto-aprendizaje");

    });

    return (
        <IndexLayout selectedIndex={2}>
            <StyledTitle>Auto-aprendizaje</StyledTitle>
            <StyledContainer>                
...
export default AutoAprendizajePage;